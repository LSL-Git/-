    ...
    <form id="form1" runat="server">
        ...
        <div class="editor_box">
            <div class="box_top">
                ...
                <asp:DropDownList ID="Type" runat="server" CssClass="article_type" Font-Size="17px">
            ...
            <div class="box_bottom">
                ...
                &nbsp;&nbsp;<asp:LinkButton ID="SaveDraft" runat="server" Font-Underline="False" ForeColor="#999999">存为草稿~</asp:LinkButton>
                &nbsp;&nbsp;<asp:Label ID="Err_Msg" runat="server" Text="" ForeColor="Red"></asp:Label>
                <div class="article_type type">
                    <asp:Label ID="Article_Type" runat="server" Text="选择分类：" Font-Size="17px"></asp:Label>
                    <asp:DropDownList ID="ArticleTypeList" runat="server" Font-Size="17px" CssClass="select_type">
                    </asp:DropDownList>
                </div>
            </div>
        </div>      
